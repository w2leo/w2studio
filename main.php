...
<html lang="en">
	...
	<body id="page-top">
		...
		<section class="page-section bg-warning text-white mb-0" id="lottery">
			<h2 class="page-section-heading text-center text-uppercase text-danger mb-4">Try your luck!</h2>
			<p class="fs-5 text-center mb-0">Input you email in form and try to win the prize!</p>
			<p class="fs-5 text-center mb-0">You can participte lottery only once a day!</p>
			<p class="fs-5 text-center">Good luck!</p>
			<form class="user" action="" method="post">
				<div class="container d-flex align-items-center justify-content-center">
					<div class="form-group form-control-user">
						<label for="inputEmail">Email address</label>
						<input type="email" class="form-control" name="userEmail" id="inputEmail" aria-describedby="emailHelp" placeholder="Enter email" />
						<small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
					</div>
					<button type="submit" class="btn btn-primary flex-row">Submit</button>
				</div>
				<div class="form-group">
					<div class="text-danger d-flex justify-content-center" id="submitReturnMessage">
				...
				<div class="row justify-content-center">
					...
					<div class="col-md-4 col-lg-3 col-sm-6 col-8 mb-5">
						<div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal2">
							...
							<img class="img-fluid rounded mx-auto d-block" src="assets/img/portfolio/2-clicker.png" alt="..." />
						</div>
					</div>
					<!-- Portfolio Item 3-->
					<div class="col-md-4 col-lg-3 col-sm-6 col-8 mb-5">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-4 mx-auto">
						...
						<p class="fs-6">C#, PHP, RestAPI, HTML, CSS, JSON, XML, Bootstrap, C++, Python, .Net framework, yaml</p>
			...
			<div class="container">
				<div class="row justify-content-center">
					...
					<div class="col-lg-4 mb-5 mb-lg-0">
						...
						<a class="btn btn-outline-light btn-social mx-1" href="https://www.facebook.com/mikhail.leonov.507" target="_blank"
							><i class="fa fa-facebook-f"></i
						></a>
						<a class="btn btn-outline-light btn-social mx-1" href="https://t.me/msleonov" target="_blank"><i class="fa fa-paper-plane"></i></a>
						<a class="btn btn-outline-light btn-social mx-1" href="https://www.linkedin.com/in/mikhail-leonov/" target="_blank"
						...
						<div class="container">
							<div class="row justify-content-center">
								<div class="col-lg-8">
									...
									<h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">Air Pollution Monitoring</h2>
									<!-- Icon Divider-->
									<div class="divider-custom">
										<div class="divider-custom-line"></div>
										<div class="divider-custom-icon">
									...
									<div id="carouselAirSite" class="carousel slide">
										<div class="carousel-inner">
											<div class="carousel-item active">
												<img src="https://d3g55nxhykyr7v.cloudfront.net/img/corousele_site/site1.png" class="d-block w-100" alt="Oops! File lost." />
											</div>
											<div class="carousel-item">
												<img src="https://d3g55nxhykyr7v.cloudfront.net/img/corousele_site/site2.png" class="d-block w-100" alt="Oops! File lost." />
											</div>
											<div class="carousel-item">
												<img src="https://d3g55nxhykyr7v.cloudfront.net/img/corousele_site/site3.png" class="d-block w-100" alt="Oops! File lost." />
											</div>
											<div class="carousel-item">
												<img src="https://d3g55nxhykyr7v.cloudfront.net/img/corousele_site/site4.png" class="d-block w-100" alt="Oops! File lost." />
											</div>
											<button
												class="carousel-control-prev bg-opacity-25 bg-secondary"
												type="button"
												data-bs-target="#carouselAirSite"
												data-bs-slide="prev">
												<span class="carousel-control-prev-icon" aria-hidden="true"></span>
												<span class="visually-hidden">Previous</span>
											</button>
											<button
												class="carousel-control-next bg-opacity-25 bg-secondary"
												type="button"
												data-bs-target="#carouselAirSite"
												data-bs-slide="next">
									...
									<p class="mb-4">
										This website allows you to monitor real-time Air pollution in different cities around the world. Filling simple login and
							...
							<div class="row justify-content-center">
								<div class="col-lg-8">
									...
									<video controls class="col-lg-10 col-6" id="video-pf-2">
										<source src="https://d3g55nxhykyr7v.cloudfront.net/2-Box_clicker.mp4" type="video/mp4" />
										Your browser does not support the video tag.
									</video>

									<!-- Portfolio Modal - Text-->
									<p class="mb-4">Unity Learn course game where the player should smash the boxes avoiding bombs. Availiable at itch.io</p>
									<p>
										<a href="https://w2leo.itch.io/boxclicker" target="_blank" class="btn btn-info">Try it now!</a>
									</p>
							...
							<div class="row justify-content-center">
								<div class="col-lg-8">
									...
									<video controls class="col-lg-10 col-6" id="video-pf-3">
										<source src="https://d3g55nxhykyr7v.cloudfront.net/3-Red ball.mp4" type="video/mp4" />
										Your browser does not support the video tag.
									</video>
									<!-- Portfolio Modal - Text-->
									<p class="mb-4">Mini game with flying red ball. Pass all obstacles and get to the finish!</p>
									<button class="btn btn-primary" data-bs-dismiss="modal">
										<i class="fa fa-xmark fa-fw"></i>
										Close Window
									</button>
							...
							<div class="row justify-content-center">
								<div class="col-lg-8">
									...
									<video controls class="col-lg-10 col-6" id="video-pf-5">
										<source src="https://d3g55nxhykyr7v.cloudfront.net/5-Collect items.mp4" type="video/mp4" />
										Your browser does not support the video tag.
									</video>
									<!-- Portfolio Modal - Text-->
									<p class="mb-4">
										Mini arcade game. The purpose of the game is to collect all items on map in a limited time. UI allows to set up level settings.
									</p>
									<button class="btn btn-primary" data-bs-dismiss="modal">
										<i class="fa fa-xmark fa-fw"></i>
										Close Window
					...
					<div class="modal-body text-center pb-5">
						<div class="container">
							<div class="row justify-content-center">
								<div class="col-lg-8">
									<!-- Portfolio Modal - Title-->
									<h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">Game map creator</h2>
									<!-- Icon Divider-->
									<div class="divider-custom">
										<div class="divider-custom-line"></div>
										<div class="divider-custom-icon">
									...
									<video controls class="col-lg-10 col-6" id="video-pf-6">
										<source src="https://d3g55nxhykyr7v.cloudfront.net/6 - MapGen.mp4" type="video/mp4" />
										Your browser does not support the video tag.
									</video>
									<!-- Portfolio Modal - Text-->
									<p class="mb-4">
										Universal map generator. Create your own beautiful worlds, include fields, lakes, mountains and oceans. Any climate zone could be
